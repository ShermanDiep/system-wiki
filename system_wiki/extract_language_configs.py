...
_handlers = importlib.import_module("system_wiki.extract_import_handlers")
...
_OBJC_CONFIG = LanguageConfig(
    ...
    call_accessor_field="",
    name_fallback_child_types=("identifier",),
    body_fallback_child_types=("implementation_definition",),
    function_boundary_types=frozenset({"method_definition"}),
    import_handler=_import_c,
)

# Placeholder configs — these languages use custom extractors in extract_custom_languages.py
_ZIG_CONFIG = None
