...
from system_wiki.constants import OUTPUT_DIR

# Import office conversion helper
_office_mod = importlib.import_module("system_wiki.detect_office_convert")
        ...
        if ftype:
            if p.suffix.lower() in OFFICE_EXTENSIONS:
                ...
                if md_path:
                    ...
                    skipped_sensitive.append(str(p) + " [office conversion failed - pip install system-wiki[office]]")
                continue
