...
from system_wiki.constants import COMMUNITY_COLORS, MAX_NODES_FOR_VIZ

_sec = importlib.import_module("system_wiki.security_helpers")
...
_tmpl = importlib.import_module("system_wiki.export_html_templates")
