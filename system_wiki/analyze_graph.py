...
# shared across report_markdown, export_json, export_html, export_wiki, export_vault
...
_CODE_EXTENSIONS = {"py", "ts", "tsx", "js", "go", "rs", "java", "rb", "cpp", "c", "h", "cs", "kt", "scala", "php", "swift", "m", "mm"}
