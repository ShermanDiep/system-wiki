...
# Import helpers from analyze_graph and cluster_communities (kebab-case modules via importlib)
_ag = importlib.import_module("system_wiki.analyze_graph")
_node_community_map = _ag._node_community_map
_is_file_node = _ag._is_file_node
_is_concept_node = _ag._is_concept_node
_surprise_score = _ag._surprise_score  # defined in analyze_graph to avoid circular import

_cc = importlib.import_module("system_wiki.cluster_communities")
